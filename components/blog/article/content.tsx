export const Content = () => {
  return (
    <div
      className="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal" //style="font-family:Georgia,serif;"
    >
      <p className="py-6">
        Welcome fellow{' '}
        <a
      ...
      <ol>
        <li className="py-3">
          ...
          dictum mi. In non dolor at sem ullamcorper venenatis ut sed dui. Ut ut est quam.
          Suspendisse quam quam, commodo sit amet placerat in, interdum a ipsum. Morbi sit amet
          tellus scelerisque tortor semper posuere.
        </li>
        <li className="py-3">
